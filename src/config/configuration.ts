export default class Configuration {
    ...
    static readonly SUCCESS_RUN_MESSAGE: string = Configuration.getEnvVariable("SUCCESS_RUN_MESSAGE");
    ...
    static readonly PRIVATE_SUBNET_ID_1: string = Configuration.getEnvVariable("PRIVATE_SUBNET_ID_1");
    static readonly PRIVATE_SUBNET_ID_2: string = Configuration.getEnvVariable("PRIVATE_SUBNET_ID_2");
